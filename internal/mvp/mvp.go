...
// Настройки обучения. Подобраны перебором на 210 матчах с ответом игры:
// при более сильном сглаживании точность на отложенной половине падает, при
// меньшем числе шагов веса не успевают разойтись.
const (
	FitL2    = 0.001
	FitSteps = 4000
	FitRate  = 0.5
