...
// Кнопки выбора карты несут матч и игрока: админ смотрит и чужие игры, и без
// аккаунта карта строилась бы по его собственной сводке матча.
func TestMapSwitch(t *testing.T) {
	...
	if row[1].Data != "k:9003682980:lane:109779233" {
